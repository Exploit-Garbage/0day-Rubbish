...
| Vulnerability class | Unauthenticated RCE via Zip Slip Webshell |
| CVSS | **9.8** |
...
- **Blog post**: <https://0day-rubbish.com/blog/brekeke-sip-server-zipslip-rce>
...
Submitted to MITRE on 2026-07-30 (CWE-22, Directory Traversal). Awaiting CVE ID.
