# Disclosure Status — Acumatica ERP
...
| Vendor | Acumatica |
| Product | ERP |
| Affected version | 2026 R1 |
| Vulnerability class | Authenticated RCE via Customization Publish Webshell |
| CVSS | **8.8** |
...
- **Blog post**: <https://0day-rubbish.com/blog/acumatica-customization-webshell-rce>
- **Published**: July 19, 2026
- Full root-cause analysis + working, reproducible PoC are public. No details withheld.

## Vendor notification

Acumatica has no public security mailbox; vendor notified 2026-07-30 via official web form https://www.acumatica.com/report-security-issue/ (submissionGuid 8a3878ec-5260-4b69-8743-99190eb612d7).

## CVE status

Submitted to MITRE on 2026-07-30 (CWE-434). Awaiting CVE ID.
