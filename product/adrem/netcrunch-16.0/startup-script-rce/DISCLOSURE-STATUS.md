...
| Vulnerability class | Authenticated SYSTEM RCE via Startup Script |
| CVSS | **8.8** |
...
- **Blog post**: <https://0day-rubbish.com/blog/adrem-netcrunch-startup-script-rce>
...
Submitted to MITRE on 2026-07-30 (CWE-94). Awaiting CVE ID.
